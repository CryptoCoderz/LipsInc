...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\LIPS
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\LIPS
    // Mac: ~/Library/Application Support/LIPS
    // Unix: ~/.LIPS
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "LIPS";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "LipsInc.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ConfPath = GetDataDir() / "LipsInc.conf";
               ...
               fprintf(ConfFile, "port=50096\n");
               fprintf(ConfFile, "rpcport=50094\n");
               fprintf(ConfFile, "rpcconnect=127.0.0.1\n");
               fprintf(ConfFile, "addnode=192.168.1.128:50096\n");
               fprintf(ConfFile, "addnode=192.168.1.128\n");
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "LipsIncd.pid"));
