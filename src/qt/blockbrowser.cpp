...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " LIPS");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " LIPS");
    }
}
...
void BlockBrowser::updateStatistics()
{
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"green\">" + qVolume + " LIPS" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " LIPS" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " LIPS");
    }
