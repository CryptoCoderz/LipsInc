...
#if defined(LIPSINC_NEED_QT_PLUGINS) && !defined(_LIPSINC_QT_PLUGINS_INCLUDED)
#define _LIPSINC_QT_PLUGINS_INCLUDED
#define __INSURE__
#include <QtPlugin>
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. LipsInc can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "LipsInc",
    ...
    app.setOrganizationName("LipsInc");
    app.setOrganizationDomain("CryptoCoderz.com");
    if(GetBoolArg("-testnet", false)) // Separate UI settings for testnet
        app.setApplicationName("LipsInc-Qt-testnet");
    else
        app.setApplicationName("LipsInc-Qt");
