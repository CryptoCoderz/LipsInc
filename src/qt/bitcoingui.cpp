    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("LipsInc") + " - " + tr("Client"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("LipsInc");
    setStyleSheet("#LipsInc {background-image: url(:/images/qt) }"); //qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #499bea, stop: 1 #207ce5
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a LipsInc address"));
    ...
    blockbrowserAction->setToolTip(tr("Browse and access block details of the LipsInc chain"));
    ...
    aboutAction = new QAction(QIcon(":icons/LipsInc"), tr("&About LipsInc"), this);
    aboutAction->setToolTip(tr("Show information about LipsInc"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for LipsInc"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/LipsInc"), tr("&Show / Hide"), this);
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit LipsInc.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for LipsInc"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit LipsInc.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for LipsInc (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where LipsInc data is stored"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-weight:bold;} QToolButton:hover { background-color: #e45e8b } QToolButton:checked { background-color: #f85b90 } QToolButton:pressed { background-color: #e8447c } #tabs { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #ec407a, stop: 1 #ff4785); border: none }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("LipsInc client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("LipsInc client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LipsInc network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid LipsInc address or malformed URI parameters."));
    }
