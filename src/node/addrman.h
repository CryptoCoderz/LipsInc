...
#ifndef _LIPSINC_ADDRMAN
#define _LIPSINC_ADDRMAN 1
...
public:
    ...
    //int GetBucketPosition(const std::vector<unsigned char> &nKey, bool fNew, int nBucket) const;
...
#define ADDRMAN_TRIED_ENTRIES_INSPECT_ON_EVICT 8
